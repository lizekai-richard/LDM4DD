...
class CIFAR10_Customized(__CIFAR_Customized):
    def __init__(self, root_dir, train=True, transforms=None, conditional=False, download=True):
        super().__init__(root_dir, cifar_class=CIFAR10, train=train, transforms=transforms, conditional=conditional, download=download)

class CIFAR100_Customized(__CIFAR_Customized):
    def __init__(self, root_dir, train=True, transforms=None, conditional=False, download=True):
        super().__init__(root_dir, cifar_class=CIFAR100, train=train, transforms=transforms, conditional=conditional, download=download)

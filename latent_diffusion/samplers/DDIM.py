...
class DDIMSampler(nn.Module):
    ...
    def step(self, x_t, t, z_t, eta=0):
        ...
        # parameters        
        alpha_cumprod_prev = self.alphas_cumprod[t_prev].where(t_prev.ge(0),
                                                               self.final_alpha_cumprod.to(device))  # >= 0
    ...
    def estimate_std(self, t, t_prev):
        ...
        alpha_cumprod_prev = self.alphas_cumprod[t_prev].where(t_prev.gt(0),
